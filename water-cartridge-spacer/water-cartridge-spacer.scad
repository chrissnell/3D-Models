...
// wall is a constant 3.5 mm.

wall         = 3.5;      // ring wall thickness (radial)
ring_outer   = 60.25;    // main ring outer radius -> Ø120.5 outer diameter
lobe_extent  = 66.625;   // outermost radius incl. lobe -> Ø133.25 extent
...
ring_mid   = (ring_inner + ring_outer) / 2;  // 58.5
...
lobe_outer = lobe_extent - ring_mid;         // 8.125
